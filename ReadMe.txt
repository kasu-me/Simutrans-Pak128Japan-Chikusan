Pak128Japan向け畜産業セット (β版) 取扱説明書a

==========================================================

【はじめに】

畜産業セットをダウンロードしていただき、ありがとうございます。
Simutrans 122.0およびOTRP v28.3のPAK128.Japanにて正常に動作することを確認しております。

こちらはベータ版となっております。今後、調整したものを再アップロードする可能性がございます。


【ファイル構成】

●pakファイルをお使いのSimutransの「pak128.Japan」フォルダに追加してください。
●textフォルダ内のja.mk_chikusan.tabは日本語化ファイルです。「pak128.Japan」フォルダ内の同名のフォルダに上書きしてください。これがないと「10匹」が「10hiki」のように非常にダサい表示となりますので、しっかり導入することを強くお勧めいたします。
...
私の作品についてはクリエイティブコモンズの表示 - 非営利 - 継承 4.0 国際に基づき使用可能とします (改造元を明記すれば非営利に限り改造再配布自由)。
できれば連絡いただけると嬉しいです。
